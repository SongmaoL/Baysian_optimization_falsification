...
- OnDemand: 
    ...
    2. Click on ![Home Directory](imgs/OnDemandDashboard.PNG)
    3. Open the ![terminal](imgs/terminal.PNG) in the Home Directory. 
...
```shell
$ cd ~
$ cp /project/jdeshmuk_786/csci513-miniproject1.zip .
...
You need to design your controller in `controller.py`. You can work:

1) directly on HPC. Refer to the [instructions](https://www.carc.usc.edu/user-guides/hpc-systems/discovery/getting-started-discovery#creating-and-editing-text-files)
Note: You need to be in the discovery (username@discovery*) and not in the singularity container or GPU node while editing files;

2) localy on you machine and transfer your code on HPC. Refer to the [instructions](https://www.carc.usc.edu/user-guides/hpc-systems/discovery/getting-started-discovery#transferring-files).